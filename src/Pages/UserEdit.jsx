...
function UserEdit(props) {
    ...
    const editUser = () => {
        Swal.fire({
            title: 'Perhatian',
            text: "Yakin akan mengubah data pengguna ini?",
            icon: 'warning',
            showCancelButton: true,
            confirmButtonColor: '#3085d6',
            cancelButtonColor: '#d33'
                ...
                Ajax.post({
                    ...
                    success: (r) => {
                        ...
                        Swal.fire({
                            icon: 'success',
                            title: 'Berhasil',
                            text: 'Data pengguna telah diedit!',
                        });
                        history.push("/kelolauser");
                    },
                    error: (r) => {
    ...
    const editPwd = () => {
        Swal.fire({
            title: 'Perhatian',
            text: "Yakin akan mengubah password pengguna ini?",
            icon: 'warning',
            showCancelButton: true,
            confirmButtonColor: '#3085d6',
            cancelButtonColor: '#d33'
                ...
                Ajax.post({
                    ...
                    success: (r) => {
                        ...
                        Swal.fire({
                            icon: 'success',
                            title: 'Berhasil',
                            text: 'Password pengguna telah diedit!',
                        });
                        history.push("/kelolauser");
                    },
                    error: (r) => {
            ...
            <div className="row">
                ...
                <Card title="Edit Password">
                        <form>
                            ...
                            <hr/>
                            <div className="form-group">
                                <AddButton posisi={btnAddPosisi} addCaption="Tambah pengguna" editCaption="Ubah password"
                                    isLoading={btnIsLoading}
                                    onClickAdd={() => addUser()}
                                    onClickEdit={() => editPwd()} />
                            </div>
