...
function PelayananServiceUpdate(props) {
    ...
    const find_pasien = () => {
        Ajax.get({
            route: `find_pasien/${id}`,
            success: (r) => {
                set_nama(r.data.nama);
                set_jenkel(r.data.jenkel);
                set_tempat_lahir(r.data.tempat_lahir);
                set_tgl_berobat(r.data.tgl_berobat);
                set_tgl_lahir(r.data.tgl_lahir);
                set_catatan(r.data.catatan);
                set_id_ruangan(r.data.id_ruangan);
                set_id_poliklinik(r.data.id_poliklinik);
                set_id_tipe_pembayaran(r.data.id_tipe_pembayaran);
            }
        });
    }
                        ...
                        Ajax.post({
                            ...
                            success: (r) => {
                                Swal.fire({
                                    icon: 'success',
                                    title: 'Berhasil',
                                    text: "Data pasien pelayanan telah diubah",
                                });
                                setBtnIsLoading(0);
                                history.push("/pelayanan_service/" + tipe);
                            }
    ...
    return (
        ...
        >
            <header> 
                <h1 className="h3 display">Ubah Data Pasien {pelayanan_service.judul ?? ""}</h1>
            </header>
...
export default PelayananServiceUpdate;