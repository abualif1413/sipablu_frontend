...
function PersonilServiceUpdate(props) {
    ...
    const find_personil = () => {
        Ajax.get({
            route: `find_personil/${id}`,
            success: (r) => {
                set_nama(r.data.nama)
                set_nip(r.data.nrp)
                set_id_pangkat(r.data.id_pangkat)
                set_jenkel(r.data.jenkel)
                set_tempat_lahir(r.data.tempat_lahir)
                set_tgl_lahir(r.data.tgl_lahir)
                set_jabatan(r.data.jabatan)
                set_tgl_masuk(r.data.tgl_masuk)
                set_status(r.data.status)
                set_id_pendidikan(r.data.id_pendidikan)
                set_str(r.data.str)
            }
        })
    }
    ...
    return (
        ...
        >
            <header> 
                <h1 className="h3 display">Ubah Data Personil : {personil_service.judul ?? ""}</h1>
            </header>
...
export default PersonilServiceUpdate;